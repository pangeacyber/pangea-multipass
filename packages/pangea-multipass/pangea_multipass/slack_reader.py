...
from .core import MultipassDocument, generate_id, PangeaMetadataKeys, PangeaMetadataValues
    ...
    def _fetch_messages(self, channel_id: str, max_messages: int = 1000) -> List:
        ...
        try:
            while total_messages < max_messages:
                ...
                page_size = page_size if (max_messages - total_messages) > page_size else (max_messages - total_messages)
